...
var parseLegacyCookies = function (apiKey_1, cookieStorage_1) {
    var args_1 = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        args_1[_i - 2] = arguments[_i];
    }
    return tslib_1.__awaiter(void 0, tslib_1.__spreadArray([apiKey_1, cookieStorage_1], tslib_1.__read(args_1), false), void 0, function (apiKey, cookieStorage, deleteLegacyCookies) {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    cookieName = (0, analytics_client_common_1.getOldCookieName)(apiKey);
